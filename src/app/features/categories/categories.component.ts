...
@Component({
  ...
  template: `
    <div class="header-container animate-fade-in">
      <div class="title-section">
        ...
        <p class="subtitle">Organize your products into logical groups</p>
      </div>
      <button mat-flat-button color="primary" class="add-btn" (click)="openAddCategoryDialog()">
    ...
    <mat-card class="table-card shadow-premium animate-fade-in">
      <div class="table-toolbar">
        <div class="search-wrapper">
          ...
          <input type="text" placeholder="Search categories..." (keyup)="applyFilter($event)" class="creative-search">
        </div>
      ...
      <div class="error-message" *ngIf="errorMessage">
        ...
        <button mat-stroked-button color="primary" (click)="loadCategories()">Try Again</button>
      </div>
      ...
      <div class="table-container" *ngIf="!isLoading && !errorMessage" [@listAnimation]="dataSource.length">
        <table mat-table [dataSource]="filteredDataSource" class="mat-elevation-z0">
          ...
          <ng-container matColumnDef="Name">
            ...
            <td mat-cell *matCellDef="let element"> 
              <div class="category-info">
                ...
                <span class="category-sub">ID: {{element.Id}}</span>
              </div>
            </td>
          </ng-container>
          ...
          <ng-container matColumnDef="IsActive">
            ...
            <td mat-cell *matCellDef="let element">
              <span class="status-badge" [class.active]="element.IsActive">
                <span class="dot"></span>
          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let element">
              <div class="action-group">
                <button mat-icon-button class="action-btn view" matTooltip="View Category" (click)="viewCategory(element)">
                  <mat-icon>visibility</mat-icon>
                </button>
                <button mat-icon-button class="action-btn edit" matTooltip="Edit Category" (click)="editCategory(element)">
                  <mat-icon>edit_note</mat-icon>
                </button>
                <button mat-icon-button class="action-btn delete" matTooltip="Delete Category" (click)="deleteCategory(element)">
      ...
      <div class="no-data" *ngIf="!isLoading && !errorMessage && dataSource.length === 0">
        <div class="empty-state">
          ...
          <p>Create your first category to start organizing your inventory.</p>
        </div>
      </div>
    </mat-card>
  `,
  styles: [`
    ...
    .category-info {
      ...
      flex-direction: column;
      gap: 4px;
      .category-name { font-weight: 700; color: var(--primary-deep); font-size: 16px; }
      .category-sub { font-size: 11px; color: #94a3b8; font-weight: 600; text-transform: uppercase; }
    }
    ...
    .hover-row {
      ...
      &:hover {
        ...
        .category-name { color: var(--accent-electric); }
      }
    }
...
export class CategoriesComponent implements OnInit {
  ...
  deleteCategory(category: Category) {
    Swal.fire({
      title: 'Are you sure?',
      text: `Do you really want to delete the category "${category.Name}"? This will affect items linked to this category.`,
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        this.categoryService.deleteCategory(category.Id).subscribe({
          ...
          error: (err) => {
            ...
            Swal.fire({
              title: 'Error!',
              text: 'Failed to delete. This category might be in use by active items.',
              icon: 'error',
